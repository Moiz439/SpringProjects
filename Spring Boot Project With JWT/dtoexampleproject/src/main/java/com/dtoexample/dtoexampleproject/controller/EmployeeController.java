...
public class EmployeeController { //class
	...
	@GetMapping("/getAllEmployee") // this Mapping used to get All Deta from Database.
	...
	@GetMapping("/getById/{id}") // this Mapping used to get All Deta from Database.
	...
	@PostMapping("/addEmployee") // This Mapping is used to Insert new Data into the Table 
	...
	@DeleteMapping("/deleteEmployee/{id}") // this Mapping is used to Delete Data From Database Table. by using id.
	...
	@PutMapping("/updateEmployee/{id}")// this Mapping is used to update the data from table.
